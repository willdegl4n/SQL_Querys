-- Consulta gráfica para monitorar o uso de CPU
  
/* O script abaixo permite que você execute uma 
  consulta gráfica no SQL SERVER para monitorar 
  o uso de CPU na sua instância. Na imagem a 
  seguir, mostro como o gráfico é apresentado 
  na aba Spatial Results.*/
